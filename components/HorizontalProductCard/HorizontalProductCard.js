      ...
      {matches !== true ? (
        <div className={classes.productPaddingHorizontaal}>
          {tags.catalogProducts.length !== 0 && (
            <div>
              <Typography className={classes.titleWeb}>{tags.displayTitle}</Typography>
        ...
        <div className={classes.productPadding}>
          {
            <div>
              {tags.catalogProducts.length !== 0 && (
                <div>
                  <Typography className={classes.titleMobil}>{tags.displayTitle}</Typography>
                      ...
                      tags.catalogProducts.map((values) => (
                        <Grid item xs={6} key={values._id}>
                          <Link
                            ...
                            as={values.slug && `/product/${values.slug}`}
                          >
                            <CardContainerVertical withBorder={"1px solid #fff"}>
                              <ProductMediaWrapper>
                                <ProgressiveImage
                                  fit={"cover"}
                                  altText={"description"}
